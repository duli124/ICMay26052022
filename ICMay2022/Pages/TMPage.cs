...
namespace ICMay2022.Pages
{
    public class TMPage
    {
        public void createNewTMRecord(IWebDriver driver)
        {
            // click on create new button
            driver.FindElement(By.XPath("//*[@id='container']/p/a")).Click();
            WaitHelpers.WaitToBeClikable(driver, "XPath", "//*[@id='TimeMaterialEditForm']/div/div[1]/div/span[1]/span/span[2]/span", 5);
            ...
            WaitHelpers.WaitToBeClikable(driver, "XPath", "//*[@id='tmsGrid']/div[4]/a[4]/span", 10);
        ...
        public void EditTM(IWebDriver driver, string description, string code, string price)
        {
            ...
            // Click on "TypeCode" from drop down list and set the Type Code
